...
using Adnc.Share.WebApi.WebApi.Registrar;
using Polly;
using Polly.Timeout;
using System;
...
{
    public static class AbstractWebApiDependencyRegistrarExtension
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<IAsyncPolicy<HttpResponseMessage>> GenerateDefaultRefitPolicies(this AbstractWebApiDependencyRegistrar _)
        {
            //隔离策略
        ...
        /// <returns></returns>
        public static List<IAsyncPolicy<HttpResponseMessage>> GenerateDefaultGrpcPolicies(this AbstractWebApiDependencyRegistrar registrar) =>
        ...
        public static bool IsDevelopment(this AbstractWebApiDependencyRegistrar _) => ASPNETCORE_ENVIRONMENT.EqualsIgnoreCase("Development");

        public static string GetEnvShortName(this AbstractWebApiDependencyRegistrar _)
        {
        ...
        public static bool IsEnableSkyApm(this AbstractWebApiDependencyRegistrar _)
        {
